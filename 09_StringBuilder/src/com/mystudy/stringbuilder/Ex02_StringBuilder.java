...
public class Ex02_StringBuilder {
	...
	public static void main(String[] args) {
		// StringBuilder 클래스
		// StringBuilder sb = "홍길동"; -> 불가 \
		StringBuilder sb = new StringBuilder("Hello Java!!!");
		System.out.println(sb);
		String str = sb.toString(); // StringBuilder 의 저장 문자열 확인(리턴)
		...
		//Hello Java!!! 반갑습니다~~~
		StringBuilder sb2 = sb.delete(0, 6); // 특정 위치 삭제 인덱스 0부터 6전까지
		...
		sb2 = new StringBuilder(100); // 저장공간
